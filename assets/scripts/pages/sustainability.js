    ...
    <main class="bg-amber-50 min-h-screen flex flex-col gap-y-5">
      ...
      <section>
        <div class="grid sm:grid-cols-3 gap-4 md:gap-6">
          ...
          <div class="rounded-2xl p-6 text-center shadow-md transition-transform duration-300 hover:-translate-y-1 bg-amber-400">
            <p class="text-4xl md:text-5xl font-bold text-amber-950 mb-1">0%</p>
            <p class="text-sm font-semibold text-amber-950">Single-Use Plastic Straws</p>
          </div>

          <div class="rounded-2xl p-6 text-center shadow-md transition-transform duration-300 hover:-translate-y-1" style="background-color:#59571B;">
            <p class="text-4xl md:text-5xl font-bold mb-1" style="color:#FDF6DC;">Daily</p>
            <p class="text-sm font-semibold" style="color:#E7E4CC;">Small-Batch Baking</p>
          </div>
      ...
      <section>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div class="bg-[#FFFFFB] rounded-2xl shadow-md p-5 text-center transition-transform duration-300 hover:-translate-y-1">
      ...
      <section class="rounded-2xl p-6 md:p-8 bg-emerald-50/50 border border-emerald-100">
        ...
        <div class="grid md:grid-cols-2 gap-5 md:gap-6">
          ...
          <div class="bg-[#FFFFFB] rounded-2xl shadow-md p-6 md:p-7 flex gap-4 items-start border border-emerald-100 transition-transform duration-300 hover:-translate-y-1">
            <div class="w-11 h-11 shrink-0 rounded-full flex items-center justify-center" style="background-color:#59571B;">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#FDF6DC" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><path d="M3 6h18"/></svg>
            </div>
          ...
          <div class="bg-[#FFFFFB] rounded-2xl shadow-md p-6 md:p-7 flex gap-4 items-start border border-emerald-100 transition-transform duration-300 hover:-translate-y-1">
            <div class="w-11 h-11 shrink-0 rounded-full flex items-center justify-center" style="background-color:#59571B;">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#FDF6DC" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2h8l4 6-10 13L2 8z"/><path d="M2 8h20"/></svg>
            </div>
      ...
      <section class="bg-[#FFFFFB] rounded-2xl shadow-md p-8 md:p-12 text-center">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-5 gap-5 md:gap-6 text-left">
          ...
          <div class="flex flex-col items-start gap-3 transition-transform duration-300 hover:-translate-y-1">
