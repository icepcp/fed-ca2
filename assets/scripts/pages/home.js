    ...
    <main class="home-page">
      ...
      <section class="hero">
        <div class="hero-content">
          ...
          <h1 class="text-3xl/12">
            Experience Banana Bliss
          </h1>
      ...
      <section class="welcome">
        ...
        <div class="category-card">
          ...
          <div>
            ...
            <p>
              ...
              smooth whipped cream, and fresh banana slices, creating a light
              and refreshing dessert perfect for any occasion.
            </p>

            <a href="#/menu"
              class="inline-block bg-yellow-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-yellow-700 transition">
              View Menu
            </a>
          </div>
        ...
        <div class="category-card">
          ...
          <div>
            ...
            <p>
              Fresh smoothies, rich vanilla ice cream blended with bananas,
              topped with whipped cream, coffee and refreshing beverages.
            </p>
          ...
          <img 
            src="/assets/images/menu/drinks/milkshake.jpeg" 
            alt="Drinks"
          >
        ...
        <div class="category-card">
          ...
          <img 
            src="/assets/images/promos/promo.jpeg" 
            alt="Promotions"
          >
          ...
          <div>
            ...
            <p>
              Enjoy exciting seasonal offers and exclusive deals.
            </p>
          </div>
      ...
      <section class="featured-products">
        ...
        <div class="product-grid">
          ...
          <div class="product-card">
            ...
            <p>
              Our original favourite made fresh daily.
            </p>
          </div>
